...
updatedAt: '2026-01-09T22:39:59.759Z'
status: published
tags:
  - architecture
  - documentation
...
* In **production**: calls [`https://openapi.doordash.com/mapping/api/v1/ip/geolocation`](https://openapi.doordash.com/mapping/api/v1/ip/geolocation) directly
...
* Routes to PARDOT\_HTTP\_MULESOFT\_PROXY\_URL
